terraform {
  source = "git::https://github.com/softwaremill/terraform-aks-bootstrap//?ref=v0.0.1"
...
inputs = {
  ...
  agents_size                    = "${get_env("CONTROLLER_NODES_TYPE")}"
  agents_count                   = 1
  agents_max_count               = get_env("CONTROLLER_MAX_NODES_NUMBER")
  agents_min_count               = 1
  ...
  node_pools = {
    "queues" = {
      ...
      vm_size             = "${get_env("QUEUE_NODES_TYPE")}"
      node_labels = {
        "node-group" = "queues"
      }
      node_tags = {
    ...
    "apps" = {
      ...
      vm_size             = "${get_env("APP_NODES_TYPE")}"
      node_labels = {
        "node-group" = "apps"
      }
      node_tags = {
